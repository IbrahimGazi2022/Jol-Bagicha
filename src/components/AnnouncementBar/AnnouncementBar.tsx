...
const AnnouncementBar = () => {
    ...
    return (
        <div className="w-full bg-gradient-to-r from-[#d8f1e4] to-[#d9f4e2] flex justify-start overflow-hidden border-b border-green-200">
            <div className="w-[1480px] px-4 md:px-6 lg:px-8 h-10 md:h-12 lg:h-10 flex items-center justify-center md:justify-between relative mx-auto">
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="text-center md:text-left text-sm md:text-base lg:text-md font-medium text-green-900 tracking-wide md:tracking-wider flex items-center justify-center md:justify-start capitalize"
                    >
                ...
                {/* Social Icons */}
                <div className="hidden md:flex items-center space-x-4 absolute right-7">
