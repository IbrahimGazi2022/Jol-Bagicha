            ...
            >
                ...
                <form className="space-y-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full bg-[#354E33] text-white py-3 rounded-lg transition-all shadow-md hover:shadow-lg font-bold tracking-wide uppercase"
                    >
                        Register
                    </motion.button>
                    ...
                    >
                        Have an account?{" "}
                        <Link to="/page/login" className="text-[#354E33] font-bold hover:underline">
                            Login
                        </Link>
                    </motion.div>
                </form>
